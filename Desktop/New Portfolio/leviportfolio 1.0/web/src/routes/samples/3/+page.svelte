<script>
    const pageData =  {
        gallery:[
            "https://firebasestorage.googleapis.com/v0/b/levithewebsitebuilder.appspot.com/o/Samples%20Images%2FSBS-Stoyline%2F1.webp?alt=media&token=0172f186-5582-43f3-a5b3-494a078dcf4e",
            "https://firebasestorage.googleapis.com/v0/b/levithewebsitebuilder.appspot.com/o/Samples%20Images%2FSBS-Stoyline%2F2.webp?alt=media&token=138cfff6-163c-4b54-af3e-89ea45f1552c",
        ],
        tags:['HTML','CSS','JavaScript','Three.js','Responsive Design'],
        name:"SBS-Stoyline",
        role:"Three.js Speacialist(Remote)",
        desc:"I was part of the team that helped design the 3D storyboards seen on the home page."
    }
</script>
