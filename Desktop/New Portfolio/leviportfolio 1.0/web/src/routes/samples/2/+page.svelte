<script>
    const pageData =  {
        gallery:[
            "https://firebasestorage.googleapis.com/v0/b/levithewebsitebuilder.appspot.com/o/Samples%20Images%2FTurbulent%2F1.webp?alt=media&token=7969d72b-663c-400f-9e99-f33e50b8b9ba",
            "https://firebasestorage.googleapis.com/v0/b/levithewebsitebuilder.appspot.com/o/Samples%20Images%2FTurbulent%2F2.webp?alt=media&token=61a9c92b-2447-4373-a809-cfa6f3c6bc92",
            "https://firebasestorage.googleapis.com/v0/b/levithewebsitebuilder.appspot.com/o/Samples%20Images%2FTurbulent%2F3.webp?alt=media&token=5e82afd0-fcc4-4c61-a7b9-d8d6491aa8b3"
        ],
        tags:['HTML','CSS','JavaScript','Three.js','Bootstrap'],
        name:"Turbulent",
        role:"Front-End Developer(Remote)",
        desc:"I worked for Turbulent.US as a front-end developer creating and implementing desgins that were responsive and utilised three.js."
    }
</script>
